...
import { Copy, Download, ArrowRight, Play, ExternalLink, MessageCircle, X } from 'lucide-react'
...
import { ResizablePanel, ResizablePanelGroup, ResizableHandle } from '@/components/ui/resizable.tsx'
        ...
        <div className="flex flex-1 overflow-hidden bg-white py-2">
          {selectedContent && selectedContent !== 'loading' && selectedContent !== 'empty' ? (
            <ResizablePanelGroup direction="horizontal" className="w-full h-full">
              {/* 主要内容区域 */}
              <ResizablePanel defaultSize={showTranscribe || showChat ? 70 : 100} minSize={30}>
                  ...
                  <ResizablePanel defaultSize={30} minSize={20} maxSize={50}>
                    <div className="h-full bg-gray-50 flex flex-col">
                      <div className="flex items-center justify-between p-3 border-b border-gray-200">
                        <h3 className="text-sm font-medium text-gray-900">原文参照</h3>
                        <Button
                          variant="ghost"
                          size="sm"
                    ...
                    <div className="h-full bg-white flex flex-col">
                      <div className="flex items-center justify-between p-3 border-b border-gray-200">
                        <div className="flex items-center gap-2">
                          ...
                          <h3 className="text-sm font-medium text-gray-900">与AI讨论</h3>
                        </div>
                        <Button
                          variant="ghost"
                          size="sm"
                      ...
                      <div className="flex-1 overflow-hidden">
                        <ChatContainer
                          ...
                          noteContent={selectedContent}
                          providerId={currentTask?.formData?.provider_id || 'gemini'}
                          modelName={currentTask?.formData?.model_name || 'gemini-1.5-flash'}
                        />
                      </div>
                    </div>
                  </ResizablePanel>
